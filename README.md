...
- **TRANSPARENT BACKGROUND** - Adds a **Transparent Background** entry to the Extras tab allowing removal of background from images.  
  Supports two models:
  - **[Inspyrenet Rembg](https://github.com/plemeri/transparent-background)** — downloaded from HuggingFace on first use.
  - **[Lucida](https://github.com/egeorcun/lucida)** — BiRefNet-based fine-tune excelling at glass, camouflage, text, glow, and line art — downloaded from HuggingFace on first use.
